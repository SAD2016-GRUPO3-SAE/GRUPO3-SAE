...
Public Class MDISAE
    ...
    Private Sub ListadoDeSociosDeNegocioToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ListadoDeSociosDeNegocioToolStripMenuItem.Click
        Dim frm As New CapaPresentacion.Reporte2()
        frm.Show()
    End Sub
End Class