...
namespace CapaPresentacion
{
    public partial class FrmMarcarEntregado : Form
    {
        ...
        public FrmMarcarEntregado(Ordenes owner)
        {
            this._owner = owner;
            InitializeComponent();
            this.labelNombre.Text = String.Format("¿Cuándo fue entregada la orden de Compra {0} ordenado el {1}?",
        ...
        private void buttonHoy_Click(object sender, EventArgs e)
        {
            ...
            mensaje = NOrdenes.MarcarEntregadoPendiente(
