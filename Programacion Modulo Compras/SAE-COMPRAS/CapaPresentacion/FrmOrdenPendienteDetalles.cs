...
{
    public partial class FrmOrdenPendienteDetalles : Form
    {
        Ordenes _owner;
        public FrmOrdenPendienteDetalles()
        {
            InitializeComponent();
        }

        public FrmOrdenPendienteDetalles(Ordenes owner)
        {
            _owner = owner;
            ...
            this.dataGridViewProductos.Columns[4].DefaultCellStyle.Format = "0.00# 'Q'";
