...
namespace CapaPresentacion
{
    public partial class FrmAgregarNuevoCliente : Form
    {
        ...
        public FrmAgregarNuevoCliente(Proveedores owner)
        {
            _owner = owner;
            InitializeComponent();
        }
        ...
        {
            String mensaje = NProveedor.Insertar(this.textBoxNombreCliente.Text, this.textBoxNombreContacto.Text, this.textBoxDireccion.Text,
